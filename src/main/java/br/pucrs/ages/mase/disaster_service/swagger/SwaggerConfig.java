package br.pucrs.ages.mase.disaster_service.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        defaultResponses.add(buildResponseMessage(HttpStatus.PRECONDITION_FAILED, "Precondition failed"));
        defaultResponses.add(buildResponseMessage(HttpStatus.INTERNAL_SERVER_ERROR, "Internal error"));
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("br.pucrs.ages.mase.disaster_service.api"))
                .build();
    }
